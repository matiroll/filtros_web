...
require 'json'
 ...
 class Alternativo < ActiveRecord::Base  
    self.table_name =  'alternativos'
  end   
   
   filename = 'filtrosPRim.csv'
   ...
   begin
    ...
    test2 = Alternativo.new(:primario=>primario,:secundario=>secundario)
    test2.save
   rescue=> e
    puts e
   end
