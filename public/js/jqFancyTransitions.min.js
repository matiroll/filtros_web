...
this.each(function(){init(this);});};$.fn.jqFancyTransitions.defaults={width:1024,height:650,strips:8,delay:3500,stripDelay:50,titleOpacity:0.7,titleSpeed:1000,position:'alternate',direction:'fountainAlternate',effect:' zipper'};})(jQuery);